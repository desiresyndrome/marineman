<?php
/*
Template Name: Service (ISF Marlins English Language Test)
*/
?>
<?php get_header(); ?>
...
<div class="service-form-flex-wrap service-form-flex-wrap-change-bg service-form-flex-wrap-change1 wraper-100"><div class="service-form-flex wraper-1240">
				<div class="service-form-flex-form"><h3 class="service-form-title"><?php _e('Online form','ds'); ?></h3><?php echo do_shortcode('[contact-form-7 id="1147" title="ISF Marlins English Language Test" html_id="feedback-form1" html_class="feedback-form placeholder_dark"]') ?></div>
