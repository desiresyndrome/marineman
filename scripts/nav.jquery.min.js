...
// Activete
$('.header-nav').nav();$(".cmn-toggle-switch").click(function(){$(".cmn-toggle-switch").toggleClass("active");$(".header-wrap").toggleClass("header-wrap_menuactive")});
if($(window).width()<1020){$('.anhor').on('click',function(){$('.cmn-toggle-switch').trigger('click')})};
$(window).resize(function(){$('.anhor').on('click',function(){$('.cmn-toggle-switch').trigger('click')})});