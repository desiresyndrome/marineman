<?php
/*
Template Name: Service (Seagull Crew Evaluation System (CES) Test)
*/
?>
<?php get_header(); ?> 
...
<div class="wrapper">
	...
	<main class="content">
		...
		<?php if ( get_field('pb2-title') ) {?>
			<div class="service-pay-block service-pay-block-change wraper-1240">
				<div class="service-pay-module"><div class="service-pay-module-inner"><?php the_field('pb2-info') ?><img src="<?php bloginfo('template_directory'); ?>/img/paysera.jpg"><a href="<?php the_field('pb2-link') ?>" class="service-pay-link"></a></div></div>
...
<div class="service-form-flex-wrap service-form-flex-wrap-change-bg service-form-flex-wrap-change1 wraper-100"><div class="service-form-flex wraper-1240">
			<div class="service-form-flex-form"><h3 class="service-form-title"><?php _e('Online form','ds'); ?></h3><div class="service-form-btn-list"><h3 class="service-form-btn-list-title"><?php _e('Select test type','ds'); ?>:</h3>
				<?php if(get_field('types-of-test')): ?>
					<?php while(the_repeater_field('types-of-test')): ?>
						<a href="javascript:void(0)" class="service-form-btn-list-item click-pop" data-title-sert="<?php the_sub_field('test-title') ?>"><span><?php the_sub_field('test-title') ?></span></a>
					<?php endwhile; ?><?php endif; ?>
				</div></div>
				<div class="service-form-flex-sample"><h3 class="service-sample-title"><?php _e('Sample Certificate','ds'); ?></h3><div class="service-sample-img"><a href="<?php the_field('sample-img') ?>" class="my-cover gallery" rel="gallery" style="background-image: url(<?php the_field('sample-img') ?>);"></a></div></div>
			</div></div>
		...
		<div class="click-pop" id="bg-popup"></div><div id="window"><?php echo do_shortcode('[contact-form-7 id="1761" title="Seagull Crew Evaluation System (CES) Test" html_id="feedback-form1" html_class="feedback-form placeholder_dark"]') ?></div>
